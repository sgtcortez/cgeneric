...
#define QUEUE_CONSTRUCT(_QUEUE_TYPE, _QUEUE_ELEMENTS)(_queue_construct(_QUEUE_ELEMENTS, sizeof(_QUEUE_TYPE)))
#define QUEUE_INIT(_QUEUE_QUEUE, _QUEUE_TYPE, _QUEUE_ELEMENTS)(_queue_init(_QUEUE_QUEUE, _QUEUE_ELEMENTS, sizeof(_QUEUE_TYPE)))
#define QUEUE_PUSH(_QUEUE_QUEUE, QUEUE_VALUE)({typeof(QUEUE_VALUE) tmp = (QUEUE_VALUE); _queue_push(_QUEUE_QUEUE, &tmp, sizeof(QUEUE_VALUE));})
#define QUEUE_DESTROY(_QUEUE_QUEUE)_queue_destroy(&_QUEUE_QUEUE)
#define QUEUE_POP(_QUEUE_QUEUE, _QUEUE_TYPE)({_QUEUE_TYPE tmp[1] = {0}; _queue_pop(_QUEUE_QUEUE, tmp); *tmp; })
...
#define QUEUE_PEEK(_QUEUE_QUEUE)({_QUEUE_TYPE tmp[1] = {0}; _queue_peek(_QUEUE_QUEUE, tmp); *tmp;}) 
